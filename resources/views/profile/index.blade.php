        ...
        <div class="col-xl-4">
            <div class="card rounded-4 shadow-sm border-0 overflow-hidden">
                <div class="card-body p-0">
                    <div class="p-4 text-white" style="background: linear-gradient(135deg, #4f46e5 0%, #22c55e 100%);">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            @if($profile->photo)
                                <img src="{{ asset('uploads/users/' . $profile->photo) }}" alt="Profile Photo" class="rounded-circle" style="width: 70px; height: 70px; object-fit: cover; box-shadow: 0 16px 40px rgba(15, 23, 42, 0.12);">
                            @else
            ...
            <div class="card rounded-4 shadow-sm border-0">
                <div class="card-header bg-white border-0 py-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <span class="badge bg-gradient rounded-pill text-white" style="background: linear-gradient(135deg, #0ea5e9 0%, #7c3aed 100%);">
